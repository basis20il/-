    ...
    <div className="bg-white rounded-2xl border border-amber-100 shadow-sm p-8 sm:p-10 space-y-8 leading-relaxed text-stone-600 animate-fade-in-up">
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1.5 mt-2">
          ...
          <li><strong>עוגיות אנליטיקה:</strong> ייטענו רק אם תאשרו זאת מפורשות, ונועדו לסייע לנו להבין כיצד משתמשים באתר ולשפר את חוויית השימוש. אינן פעילות כברירת מחדל.</li>
