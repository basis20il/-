...
export const PrivacyPolicy: React.FC = () => (
  <div className="max-w-3xl mx-auto px-6 py-20">
    ...
    <div className="bg-white rounded-2xl border border-amber-100 shadow-sm p-8 sm:p-10 space-y-8 leading-relaxed text-stone-600 animate-fade-in-up">
      ...
      <section>
        <h2 className="font-bold text-lg text-amber-950 mb-2">6. עוגיות (Cookies) ואחסון מקומי</h2>
        <p>האתר משתמש באחסון מקומי בדפדפן (Local Storage) לצורך שמירת תוכן עגלת הקניות שלכם בין ביקורים, ובעוגיות טכניות הנדרשות לצורך ניהול ההתחברות וההפעלה התקינה של האתר.</p>
      </section>
