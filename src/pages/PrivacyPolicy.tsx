    ...
    <div className="bg-white rounded-2xl border border-amber-100 shadow-sm p-8 sm:p-10 space-y-8 leading-relaxed text-stone-600 animate-fade-in-up">
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1.5 mt-2">
          ...
          <li><strong>עוגיות אנליטיקה ומעקב גלישה:</strong> ייטענו רק אם תאשרו זאת מפורשות. בקטגוריה זו נעשה שימוש בכלי ניתוח גלישה צד-שלישי המתעדים נתונים כגון עמודים שנצפו, זמן שהייה, מיקום גאוגרפי כללי וסוג מכשיר/דפדפן. הנתונים הנאספים משמשים אותנו להבנת אופן השימוש באתר ולשיפורו, ועשויים להיות מועברים לשרתי הספקים בהתאם למדיניות הפרטיות שלהם. אינן פעילות כברירת מחדל.</li>
