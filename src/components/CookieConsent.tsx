        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-stone-600 leading-relaxed">
              ...
              <strong> כלי המעקב והניתוח יופעלו רק אם תלחצו על "אישור הכל" או תאשרו זאת באופן מפורש בהתאמה אישית — אם אינכם מעוניינים שנעקוב אחרי הגלישה שלכם, פשוט לחצו "דחיית הכל".</strong> כניסה ושימוש באתר מהווים הסכמה לקבלת הודעות ועדכונים הקשורים להזמנות שלכם, וכן עדכונים כלליים מהקונדיטוריה (כגון מבצעים והודעות שירות), בהתאם למדיניות הפרטיות שלנו. לפרטים מלאים ראו את <Link to="/privacy-policy" className="font-bold text-amber-800 hover:underline">מדיניות הפרטיות והעוגיות</Link> שלנו.
            </p>
          </div>
        </div>
